...
export const fetchJoinedInitiatives = createAsyncThunk(
  ...
  async (userId: string | number) => {
    try {
      const response = await axios.get(`${URL}social/getUserJoins/${userId}`);
...
export const fetchLikedInitiatives = createAsyncThunk(
  ...
  async (userId: string | number) => {
    try {
      const response = await axios.get(`${URL}social/getUserLikes/${userId}`);
      return response.data.dataIterable;
    } catch (error) {
...
export const sendLikeDislike = createAsyncThunk(
  ...
  async ({
    ...
    try {
      ...
      const response = await axios.post(`${URL}social/socials`, {
        idCliente: userId,
...
export const sendJoinLeave = createAsyncThunk(
  ...
  async ({
    ...
    try {
      await axios.post(`${URL}social/socials`, {
        idCliente: userId,
        idIniciativa: initiativeId,
        join: isJoined,
      });
