...
export const createInitiative = createAsyncThunk<
  ...
  CreateInitiativeRequestData
>("initiatives/createInitiative", async (requestData, { rejectWithValue }) => {
  ...
  try {
    const response = await axios.post(`${URL}iniciativa/add`, dataToSend);
